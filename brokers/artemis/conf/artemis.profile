...
ARTEMIS_HOME='/opt/broker/apache-artemis-2.6.3'
ARTEMIS_INSTANCE='/opt/broker/instance'
ARTEMIS_DATA_DIR='/opt/broker/instance/data'
ARTEMIS_ETC_DIR='/opt/broker/instance/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/opt/broker/instance/'
ARTEMIS_INSTANCE_ETC_URI='file:/opt/broker/instance/etc/'
